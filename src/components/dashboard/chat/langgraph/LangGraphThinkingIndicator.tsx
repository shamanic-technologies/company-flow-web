...
const LangGraphThinkingIndicator = () => {
  return (
    <div className="flex items-start gap-3 px-2 py-3 rounded-lg bg-muted/30">
      <div className="flex-1 overflow-hidden min-w-0">
        ...
        <div className="mt-2 text-muted-foreground" style={{ fontSize: '11px' }}>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="inline-block bg-gradient-to-r from-muted-foreground via-foreground to-muted-foreground bg-[length:200%_100%] animate-[shimmer_3s_linear_infinite] bg-clip-text text-transparent will-change-[background-position]">
              Generating...
            </span>
          </div>
        </div>
...
export default LangGraphThinkingIndicator; 